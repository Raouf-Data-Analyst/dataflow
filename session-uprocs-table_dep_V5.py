...
def plot_network_graph():
   ...
   # Plot the interactived diagram using pyvis
    nt = Network(height="750px", width="100%", bgcolor="#222222", font_color="white", directed=False, notebook=True,cdn_resources='remote', select_menu = True, filter_menu=True,heading="data dependency" )  
